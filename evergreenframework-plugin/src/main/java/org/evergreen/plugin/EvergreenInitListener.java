...
public class EvergreenInitListener implements ServletContextListener {
	...
	public void contextDestroyed(ServletContextEvent event) {
		BeanFactory factory = (BeanFactory)event.getServletContext().getAttribute(EvergreenActionHandler.BEAN_FACTORY);
		factory.close();
		event.getServletContext().removeAttribute(EvergreenActionHandler.BEAN_FACTORY);
	}
